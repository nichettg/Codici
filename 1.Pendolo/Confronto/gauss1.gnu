...
# Dati 1
f1(x) = 1 / (sqrt(2. * pi) * c1) * exp(-((x - b1)**2.) / (2. * c1**2.))
#a1= 6.104
b1= 2.04404
c1= 0.0971551
fit f1(x) "plot1.txt" using 1:2 via b1, c1

# Dati 3
f3(x) = 1 / (sqrt(2. * pi) * c3) * exp(-((x - b3)**2.) / (2. * c3**2.))
#a3= 6.5
b3= 1.99
c3= 0.131418
fit f3(x) "plot3.txt" using 1:2 via b3, c3

# Dati 4
f4(x) = 1 / (sqrt(2. * pi) * c4) * exp(-((x - b4)**2.) / (2. * c4**2.))
#a4= 2.323
b4= 2.07653
c4= 0.0371332
fit f4(x) "plot4.txt" using 1:2 via b4, c4
