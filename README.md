...
+ Z:  fare l'analisi delle immagini della aberrazione con ImaJ facendo profilo d'intensità sul diametro, scegliere i confini del foro stabilendo la percentuale di intensità, porre il diametro pari a 0.5mm e fare la misura della distanza dei fori marginali, così per tutte le immagini di quelle sfocate e a fuoco
+ Z: implementare il programma (o fare un programma separato) per il calcolo delle aberrazioni sferiche longitudinali e trasversali per ogni colore e poi quelle cromatiche sia per i marginali che trasversali; va implementata anche la correzione degli errori sistematico della lente spessa anche per la lente 2 per il calcolo delle aberrazioni
+ S: fare la tabella dei dati grezzi senza sistematiche
+ S: fare la tabella dei dati corretti con le sistematiche, covarianza
+ S: fare la tabella delle misure delle posizioni/distanze usate per analizzare i dati
+ S: fare la tabella dei risultati delle focali, indice compatibilità, parametri ottimali con incertezze
+ S: fare la tabella dei risultati delle aberrazioni
