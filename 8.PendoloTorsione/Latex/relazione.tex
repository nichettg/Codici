...
\begin{figure}[H]
    \centering
    \subfigure{\includegraphics[width=0.90\textwidth]{/home/nichettg/Codici/Laboratorio/8.PendoloTorsione/Images/ConfrontoForzanti.pdf}}
...
\begin{figure}[h!]
    \centering
    \subfigure{\includegraphics[width=0.90\textwidth]{/home/nichettg/Codici/Laboratorio/8.PendoloTorsione/Images/ConfrontoMassimi.pdf}}
...
\begin{figure}[h!]
    \centering
    \subfigure{\includegraphics[width=0.70\textwidth]{/home/nichettg/Codici/Laboratorio/8.PendoloTorsione/Images/ConfrontoSmorzati.pdf}}
  \caption{Confronto del moto smorzato (con correzione di offset già applicata): sopra la prima giornata, sotto la seconda}
\end{figure}

\begin{figure}
    \centering
    \subfigure{\includegraphics[width=0.70\textwidth]{/home/nichettg/Codici/Laboratorio/8.PendoloTorsione/Images/ConfrontoMassimiSmorzamento.pdf}}
...
\hline
\textbf{Frequenza Forzante} & \textbf{Pearson} & \textbf{p-value Student} & \textbf{Compatibile con -1} \\
\hline
0.90 Hz & $(-93.2 \pm 5.1) \times 10^{-2}$ & 0.0955 & Sì \\
\hline
0.97 Hz & $(-98.9 \pm 1.6) \times 10^{-2}$ & 0.2496 & Sì \\
\hline
0.98 Hz & $(-96.5 \pm 2.8) \times 10^{-2}$ & 0.1095 & Sì \\
\hline
0.99 Hz & $(-94.9 \pm 3.6) \times 10^{-2}$ & 0.0789 & Sì \\
\hline
1.00 Hz & $(-94.6 \pm 5.1) \times 10^{-2}$ & 0.1494 & Sì \\
\hline
\end{tabular}
...
\textbf{Frequenza Forzante} & \textbf{Pearson} & \textbf{p-value Student} & \textbf{Compatibile con -1} \\
\hline
0.91 Hz & $(-93.2 \pm 5.0) \times 10^{-2}$ & 0.0911 & Sì \\
\hline
0.92 Hz & $(-95.9 \pm 4.5) \times 10^{-2}$ & 0.1837 & Sì \\
\hline
0.93 Hz & $(-95.0 \pm 4.2) \times 10^{-2}$ & 0.1229 & Sì \\
\hline
0.94 Hz & $(-94.4 \pm 3.7) \times 10^{-2}$ & 0.0633 & Sì \\
\hline
0.955 Hz & $(-98.4 \pm 1.8) \times 10^{-2}$ & 0.1874 & Sì \\
\hline
0.9575 Hz & $(-99.4 \pm 1.1) \times 10^{-2}$ & 0.3075 & Sì \\
\hline
0.95 Hz & $(-97.7 \pm 2.2) \times 10^{-2}$ & 0.1545 & Sì \\
\hline
0.96125 Hz & $(-995.3 \pm 9.8) \times 10^{-3}$ & 0.3162 & Sì \\
\hline
0.96183 Hz & $(-99.3 \pm 1.3) \times 10^{-2}$ & 0.2878 & Sì \\
\hline
0.9625 Hz & $(-99.0 \pm 1.4) \times 10^{-2}$ & 0.2388 & Sì \\
\hline
0.965 Hz & $(-99.4 \pm 1.2) \times 10^{-2}$ & 0.2962 & Sì \\
\hline
0.96 Hz & $(-98.9 \pm 1.4) \times 10^{-2}$ & 0.2293 & Sì \\
\hline
0.97 Hz & $(-99.0 \pm 1.5) \times 10^{-2}$ & 0.2493 & Sì \\
\hline
\end{tabular}
