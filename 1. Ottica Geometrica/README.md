...
I file "compatibilita_coniugati.txt" e "compatibilita_bessel.txt" riassumono tutti i metodi usati per calcolare i vari valori delle focali per i due metodi (per dettagli vedere il file jupyter) e mostrano le compatibilità tra i vari metodi.
